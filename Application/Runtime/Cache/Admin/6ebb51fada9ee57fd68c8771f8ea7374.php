  ...
  <ul class="nav navbar-nav navbar-right navbar-user">
    <li class="dropdown messages-dropdown">
      <p class="navbar-text pull-right">
         ...
         <div class="row">
          <form action="<?php echo U('logs');;?>" method="get" id="queryForm">
            <div class="col-lg-12">
              <div role="form" class="form-inline">
                <div class="form-group col-lg-4">
                    <label>操作编号：</label>
                    <input type="text" class="form-control" name="id" value="<?php echo ($params['id']); ?>">
                </div>
                <div class="form-group col-lg-4" style="margin-bottom:5px;">
                    <label>修改者ID：</label>
                    <input type="text" class="form-control" name="userId" value="<?php echo ($params['userId']); ?>">
                  </div>
                <div class="form-group col-lg-4">
                    <label>修改者姓名：</label>
                    <input type="text" class="form-control" name="userName" value="<?php echo ($params['userName']); ?>">
                </div>
              </div>
            </div>
             ...
             <div class="col-lg-12" style="margin-bottom:5px;">
              <div role="form" class="form-inline">
                  <div class="form-group col-lg-4">
                      <label>创建时间：</label>
                    <input readonly  type="text" class="form-control" name="createTime" value="<?php echo ($params['createTime']); ?>" id="createTime">
                  </div>
              ...
              <table class="table table-bordered table-hover table-striped tablesorter">
                ...
                <tbody>
                    <?php if(is_array($list)): foreach($list as $key=>$vo): ?><tr>
                          <td><?php echo str_pad($vo['operation_id'],8,'0',STR_PAD_LEFT);;?></td>
                          <td><?php echo ($vo["operation_user_id"]); ?></td>
                          <td><?php echo ($vo["operation_user"]); ?></td>
                          <td><?php echo ($vo["operation_time"]); ?></td>
                          <td><?php echo ($vo["operation_action"]); ?></td>
                          <td><?php echo ($vo["operation_object"]); ?></td>
                          <td><?php echo ($vo["operation_ip"]); ?></td>
                          <td><?php echo ($vo["operation_remark"]); ?></td>
                          <!-- <td>
                            <a data-info="<?php echo ($vo["operation_id"]); ?>" class="deleteLog">删除</a>
                          </td> -->
    ...
    <script>
      var deleteUrl = '/ling_test/admin/Log/delete';
    </script>
    <!-- date time picker  -->
    <link rel="stylesheet" type="text/css" href="/ling_test/Public/css/bootstrap-datetimepicker.css">
    <script type="text/javascript" src="/ling_test/Public/js/bootstrap-datetimepicker.min.js" charset="UTF-8"></script>
    <script type="text/javascript" src="/ling_test/Public/js/bootstrap-datetimepicker.fr.js" charset="UTF-8"></script>
    <script type="text/javascript" src="/ling_test/Public/js/bootstrap-datetimepicker.zh-CN.js" charset="UTF-8"></script>
    <script type="text/javascript" src="/ling_test/Public/js/Admin/Log/logs.js"></script>
