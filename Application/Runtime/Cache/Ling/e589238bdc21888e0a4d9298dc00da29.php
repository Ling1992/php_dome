...
<div class="collapse navbar-collapse navbar-ex1-collapse">
  ...
  <ul class="nav navbar-nav navbar-right navbar-user">
    ...
    <div>
        <h4 style="margin-left: 1%" id="edit_type_title">大小写测试</h4>
    </div>
        ...
        <div class="col-md-7">
            <table class="table table-bordered ling-table-type-1">
                <tr>
                    <td>ajax 调接口</td>
                    <td>
                        <button class="btn btn-default" onclick="test1()" autofocus>test_one</button>
                    </td>
                </tr>
                <tr>
                    <td>ajax 调接口</td>
                    <td>
                        <button class="btn btn-default" onclick="test2()">testOneAction</button>
                    </td>
                </tr>
                <tr>
                    <td> U 方法  _CONTROLLER__ _SELF__</td>
                    <td>
                        <button><?php echo U('testOneAction');?></button>
                        <button>/ling_test/ling/test/testOne</button>
                        <button>/ling_test/Ling/Test/testOne?selectMenu1Id=6&amp;selectMenu2Id=7</button>
                    </td>
                </tr>
                <tr>
                    <td> 调用 Compub 模块</td>
                    <td>,,,
                        <button class="btn btn-default" onclick="test3()">test</button>
                    </td>
                </tr>
            </table>
        </div>
    ...
    <script>
        function test1() {
            $.ajax({
                url:'/ling_test/ling/test/test_one',
                type:'post',
                data:{},
        ...
        function test2() {
            $.ajax({
                url:'/ling_test/ling/test/testOneAction',
                type:'post',
                data:{},
                success:function (info) {
                    console.log(info);
        ...
        function test3() {
            $.ajax({
                url:"<?php echo U('Compub/Common/test');?>",
                type:'post',
                data:{},
                success:function (info) {
                    console.log(info);
