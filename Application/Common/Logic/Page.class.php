...
class Page extends \Think\Page{
    ...
    public $isType = 1;  //分页标签显示大小1:普通2:pagination-sm
    ...
    public function show() {
        ...
        for($i = 1; $i <= $this->rollPage; $i++){
            ...
            if($page > 0 && $page != $this->nowPage){
                ...
                if($page > 0 && $this->totalPages != 1){
                    ...
                    $link_page .= '<li class="disabled"><a class="current">' . $page . '</a></li>';
                }
            }
        }
        ...
        //bootstrap 分页样式大小
        if($this->isType==2){
            $ulPageSzie = 'pagination-sm';
        }
        return "<ul class='pagination {$ulPageSzie}'>{$page_str}</ul>";
    }
